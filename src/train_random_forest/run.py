...
def go(args):
    ...
    # Fix stratification issue: set to None if 'stratify_by' is 'none'
    stratify_col = X[args.stratify_by] if args.stratify_by in X.columns else None
    ...
    sk_pipe.fit(X_train, y_train) # added
    ...
    mlflow.sklearn.save_model( # added
        sk_pipe,
